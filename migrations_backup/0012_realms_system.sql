...
(1, '胎息境', 1, 1, '凡蜕期', 3153600000, 0, 157680000, '锁住先天灵气', '若5岁前未入此境，先天灵气散尽，沦为凡人', NULL, NULL, 1),
...
-- 插入化境期：因果纠缠 (10-14境)
INSERT OR IGNORE INTO realms (id, name, major_realm, sub_realm, major_realm_name, lifespan_max, breakthrough_age_min, breakthrough_age_max, description, core_logic, cultivation_span_min, cultivation_span_max, sort_order) VALUES
(10, '破茧境', 3, 1, '化境期', 126144000000, NULL, NULL, '彻底抛弃凡人肉身', '修成法躯', 31536000000, 63072000000, 10),
(11, '化神境', 3, 2, '化境期', 252288000000, NULL, NULL, '元神出窍', '死亡判定不再看肉身，只看元神能量', 63072000000, 126144000000, 11),
(12, '炼虚境', 3, 3, '化境期', 630720000000, NULL, NULL, '领悟空间', '寿元开始出现非线性跳跃', 126144000000, 252288000000, 12),
(13, '合道境', 3, 4, '化境期', 1576800000000, NULL, NULL, '意志与局部天地融合', '与天地共鸣', 252288000000, 630720000000, 13),
(14, '渡厄境', 3, 5, '化境期', 3153600000000, NULL, NULL, '经历第一重"死劫"', '每秒流逝寿元变为2倍，逼迫玩家加快进度', 630720000000, 1576800000000, 14);

-- 插入极境期：法则剥离 (15-18境)
INSERT OR IGNORE INTO realms (id, name, major_realm, sub_realm, major_realm_name, lifespan_max, breakthrough_age_min, breakthrough_age_max, description, core_logic, cultivation_span_min, cultivation_span_max, sort_order) VALUES
(15, '大乘境', 4, 1, '极境期', 9460800000000, NULL, NULL, '法力圆满', '开始斩断现世羁绊', 1576800000000, 4730400000000, 15),
(16, '斩因境', 4, 2, '极境期', 25228800000000, NULL, NULL, '斩断因果', '不会因他人推算或诅咒而减寿', 4730400000000, 12614400000000, 16),
(17, '溯源境', 4, 3, '极境期', 94608000000000, NULL, NULL, '寻找生命最初的编码', '追溯本源', 12614400000000, 31536000000000, 17),
(18, '轮回境', 4, 4, '极境期', 315360000000000, NULL, NULL, '掌控生死律', '可赋予NPC或其他玩家寿元', 31536000000000, 157680000000000, 18);

-- 插入道极期：永恒观者 (19-20境)
INSERT OR IGNORE INTO realms (id, name, major_realm, sub_realm, major_realm_name, lifespan_max, breakthrough_age_min, breakthrough_age_max, description, core_logic, cultivation_span_min, cultivation_span_max, sort_order) VALUES
(19, '涅槃境', 5, 1, '道极期', 3153600000000000, NULL, NULL, '经历九次宇宙毁灭而不死', '每次重生提升200%效率', NULL, NULL, 19),
(20, '永恒境', 5, 2, '道极期', 9999999999999999, NULL, NULL, '彻底超越时间维度', '不再受系统"寿命扣除"机制限制', NULL, NULL, 20);
